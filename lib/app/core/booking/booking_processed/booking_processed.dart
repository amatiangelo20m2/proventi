...
class ProcessedBookings extends StatefulWidget {
  ...
  static String routeName = 'processed_bookings';
...
class _ProcessedBookingsState extends State<ProcessedBookings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Prenotazioni processate', style: TextStyle(color: blackDir, fontSize: 16),),
        backgroundColor: Colors.white,
        surfaceTintColor: Colors.white,
      ),
      body: Consumer<RestaurantStateManager>(
