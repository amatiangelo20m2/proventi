        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              Column(
                children: [
                  Lottie.asset('assets/lotties/danger.json', height: 200),
                  const Text('Configurazione non trovata o compromessa in modo critico.', style: TextStyle(fontSize: 15, color: Colors.black)),
                  const Text('Premi il tasto per fare un reset completo.', style: TextStyle(fontSize: 10, color: Colors.black)),
                ],
              ),
              SizedBox(
                height: 160,
                ...
                child: ElevatedButton(
                    ...
                    ) : Text('RESET', style: TextStyle(fontSize: 40, color: Colors.black),)),
              ),
            ],
          ),
        );
