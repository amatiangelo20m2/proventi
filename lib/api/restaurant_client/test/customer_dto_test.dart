...
void main() {
  // final instance = CustomerDTO();

  group('test CustomerDTO', () {
    // int customerId
    ...
    // int presenceCount
    test('to test the property `presenceCount`', () async {
      // TODO
    });
    ...
    test('to test the property `lastPresence`', () async {
      // TODO
    });

    // int flames
    test('to test the property `flames`', () async {
      // TODO
    });
    ...
    // bool privacyConsent
    test('to test the property `privacyConsent`', () async {
      // TODO
    });
    ...
    test('to test the property `profilingConsent`', () async {
      // TODO
    });

    // bool emailSpamOptOut
    test('to test the property `emailSpamOptOut`', () async {
      // TODO
    });
