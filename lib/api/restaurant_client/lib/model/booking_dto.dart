...
class BookingDTO {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.privateNotes != null) {
      json[r'privateNotes'] = this.privateNotes;
    } else {
...
class BookingDTOStatusEnum {
  ...
  static const ELIMINATO_DA_UTENTE = BookingDTOStatusEnum._(r'ELIMINATO_DA_UTENTE');
  static const MODIFICA_CONFERMATA = BookingDTOStatusEnum._(r'MODIFICA_CONFERMATA');
  static const MODIFICA_RIFIUTATA = BookingDTOStatusEnum._(r'MODIFICA_RIFIUTATA');
  ...
  BookingDTOStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'ELIMINATO_DA_UTENTE': return BookingDTOStatusEnum.ELIMINATO_DA_UTENTE;
        case r'MODIFICA_CONFERMATA': return BookingDTOStatusEnum.MODIFICA_CONFERMATA;
        case r'MODIFICA_RIFIUTATA': return BookingDTOStatusEnum.MODIFICA_RIFIUTATA;
