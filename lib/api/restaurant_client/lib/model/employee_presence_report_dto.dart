...
class EmployeePresenceReportDTO {
  ...
  @override
  String toString() => 'EmployeePresenceReportDTO[reportId=$reportId, branchCode=$branchCode, employee=$employee, date=$date, workedHours=$workedHours, note=$note, holiday=$holiday, presentAtDinner=$presentAtDinner, presentAtLunch=$presentAtLunch, illness=$illness, rest=$rest]';
