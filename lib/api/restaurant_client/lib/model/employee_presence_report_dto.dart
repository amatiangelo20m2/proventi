...
class EmployeePresenceReportDTO {
  ...
  @override
  String toString() => 'EmployeePresenceReportDTO[reportId=$reportId, branchCode=$branchCode, employee=$employee, date=$date, workedHours=$workedHours, note=$note, presentAtLunch=$presentAtLunch, holiday=$holiday, illness=$illness, presentAtDinner=$presentAtDinner, rest=$rest]';
