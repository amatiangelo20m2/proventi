...
class Overview {
  ...
  int get hashCode =>
    ...
    (thisWeek == null ? 0 : thisWeek!.hashCode) +
    (lastWeek == null ? 0 : lastWeek!.hashCode);

  @override
  String toString() => 'Overview[thisWeek=$thisWeek, lastWeek=$lastWeek]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
    if (this.thisWeek != null) {
      json[r'thisWeek'] = this.thisWeek;
    } else {
      json[r'thisWeek'] = null;
    }
    if (this.lastWeek != null) {
      json[r'lastWeek'] = this.lastWeek;
    } else {
      json[r'lastWeek'] = null;
    }
    return json;
  }
  ...
  static Overview? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Overview(
        thisWeek: WeekMetrics.fromJson(json[r'thisWeek']),
        lastWeek: WeekMetrics.fromJson(json[r'lastWeek']),
      );
    }
    return null;
  }
