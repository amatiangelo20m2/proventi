...
class Credentials {
  ...
  int get hashCode =>
    ...
    (fmcToken == null ? 0 : fmcToken!.hashCode);

  @override
  String toString() => 'Credentials[name=$name, email=$email, password=$password, company=$company, avatar=$avatar, phone=$phone, fmcToken=$fmcToken]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.fmcToken != null) {
      json[r'fmcToken'] = this.fmcToken;
    } else {
      json[r'fmcToken'] = null;
    }
    return json;
  }
  ...
  static Credentials? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Credentials(
        ...
        fmcToken: mapValueOfType<String>(json, r'fmcToken'),
      );
    }
    return null;
  }
